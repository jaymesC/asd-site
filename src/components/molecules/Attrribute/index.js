...
import { StyledAnchor, StyledLink, StyledH1, StyledH4, StyledPicture, StyledRow, StyledSvg, StyledParagraph } from './styles';
  ...
  return (
    <>
      <StyledRow>
        ...
        <section>
          <StyledSvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" fill={color}>
          ...
          <StyledPicture src={img} alt="" data-aos="fade-right" data-aos-duration="1500" />
        </section>
      </StyledRow>
    </>
  );
