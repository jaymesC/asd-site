...
export default function Attribute({writeup1,writeup2, img, color}) {
...
line-height:30px;
  ...
  return (
    <>
      <Row>
        ...
        <section>
        <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" data-aos="fade-up" style={{fill:{color}}}>
  ...
  <Picture  src={img} alt="" data-aos="fade-right"/>
