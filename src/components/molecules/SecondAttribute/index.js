...
import  { StyledAnchor, StyledLink, StyledH1, StyledH4, StyledPicture, StyledRow, StyledSvg, StyledParagraph, StyledDiv } from './styles';
 ...
 const Attribute = ({ FirstText, SecondText, ThirdText, img, color })  => {
  ...
  return (
    <>
      <StyledRow>
        <section>
          <StyledSvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" data-aos="fade-up" fill={color}>
          ...
          <StyledPicture src={img} alt="" data-aos="fade-left" data-aos-duration="1000" />
        </section>

        <StyledDiv data-aos="fade-right" data-aos-duration="1000">
