...
const Home = () => {
  ...
  return (
    <>
      ...
      <Attribute
        writeup1="Integrity"
        writeup2="Here at ASD, we promise to be open, honest, ethical and fair. "
        writeup3="Our reputation is built on trust and we are committed to stick to our
      ...
      <Attribute
        ...
        writeup3="The sporting industry is ever changing and ASD are devoted to being at the forefront of any
      ...
      <Attribute
        ...
        writeup3="Thus allowing confidence in our work as well as providing sporting
